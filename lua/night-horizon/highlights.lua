local c = require("night-horizon.colors")
local cfg = vim.g.onedark_config
local util = require("night-horizon.util")
...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
	hl.treesitter = {
		...
		["@error"] = colors.Fg,
		["@function"] = { fg = c.cloud, fmt = cfg.code_style.functions },
		["@function.builtin"] = { fg = c.cloud, fmt = cfg.code_style.functions },
		["@function.macro"] = { fg = c.cyan, fmt = cfg.code_style.functions },
		["@function.method"] = { fg = c.cloud, fmt = cfg.code_style.functions },
		["@keyword"] = { fg = c.sky, fmt = cfg.code_style.keywords },
		["@keyword.conditional"] = { fg = c.sky, fmt = cfg.code_style.keywords },
		["@keyword.directive"] = colors.Sky,
		["@keyword.exception"] = colors.Sky,
		["@keyword.function"] = { fg = c.sky, fmt = cfg.code_style.functions },
		["@keyword.import"] = colors.Sky,
		["@keyword.operator"] = { fg = c.sky, fmt = cfg.code_style.keywords },
		["@keyword.repeat"] = { fg = c.sky, fmt = cfg.code_style.keywords },
		["@label"] = colors.Red,
		...
		["@danger"] = colors.Fg,
		["@type"] = colors.Yellow,
		["@type.builtin"] = colors.Sky,
		["@variable"] = { fg = c.fg, fmt = cfg.code_style.variables },
		["@variable.builtin"] = { fg = c.sky, fmt = cfg.code_style.variables },
		["@variable.member"] = colors.Fg,
		["@variable.parameter"] = colors.Greener,
		...
		["@float"] = colors.Orange,
		["@include"] = colors.Purple,
		["@method"] = { fg = c.cloud, fmt = cfg.code_style.functions },
		["@namespace"] = colors.Yellow,
		["@parameter"] = colors.Greener,
		["@preproc"] = colors.Purple,
	...
	hl.treesitter = {
		...
		TSFunction = { fg = c.cloud, fmt = cfg.code_style.functions },
		...
		if color_name:sub(1, 1) == "$" then
			...
			if not color_name then
				vim.schedule(function()
					vim.notify(
						'night-horizon.nvim: unknown color "' .. name .. '"',
						vim.log.levels.ERROR,
						{ title = "night-horizon.nvim" }
					)
				end)
				return ""
			end
