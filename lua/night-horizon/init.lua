...
---Change night-horizon option (vim.g.onedark_config.option)
...
---Apply the colorscheme (same as ':colorscheme night-horizon')
function M.colorscheme()
	...
	vim.g.colors_name = "night-horizon"
	if vim.o.background == "light" then
		M.set_options("style", "light")
	elseif vim.g.onedark_config.style == "light" then
		M.set_options("style", "light")
	end
	require("night-horizon.highlights").setup()
	require("night-horizon.terminal").setup()
end

---Toggle between night-horizon styles
function M.toggle()
	...
	vim.api.nvim_command("colorscheme night-horizon")
end
...
---Setup night-horizon.nvim options, without applying colorscheme
...
function M.setup(opts)
	...
	if vim.g.onedark_config.toggle_style_key then
		vim.api.nvim_set_keymap(
			...
			'<cmd>lua require("night-horizon").toggle()<cr>',
